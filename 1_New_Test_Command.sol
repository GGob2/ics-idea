...
/*
    (01/21)
    나눠야함.. : Emp 컨트랙트를 다시 Contract 1개로 가져와서 통합시킨 뒤 사용해보자.
*/
...
contract Command_1 {
    ...
    function verify(uint _numOfVerifyingGroup) public payable returns (bool) {
        ...
        sumOfVerifyingScore += getEmpScore(randomNumList[_numOfVerifyingGroup]);
        sumOfVerifyingGroupTrustScore += getEmpTrustScore(randomNumList[_numOfVerifyingGroup]);
